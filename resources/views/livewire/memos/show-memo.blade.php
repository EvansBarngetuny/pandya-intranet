...
<!-- Audience Information Section - ADD THIS HERE -->
    ...
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            ...
            <div class="mt-1">
                ...
                <!-- Memo Content - Main Content Area -->
                <div class="mb-8">
                ...
                <!-- Audit Trail Toggle Button for Admin/HOD -->
                ...
                <button wire:click="exportAuditTrailPDF"
                        class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition flex items-center gap-2">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                    </svg>
                    Export PDF
                ...
                <button wire:click="exportAuditTrailExcel"
                        class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition flex items-center gap-2">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-4 border rounded-lg overflow-hidden">
                            ...
                            <div class="bg-gray-50 px-4 py-3 border-t text-xs text-gray-500">
                                <div class="flex justify-between">
                                    <span>Total Staff: {{ count($memo->getAllUsersAuditTrail()) }}</span>
                                    <span>Read: {{ $memo->readBy()->count() }}</span>
                                    <span>Acknowledged: {{ $memo->acknowledgments()->count() }}</span>
                                    <span>Completion Rate: {{ $memo->acknowledgment_percentage }}%</span>
                                </div>
                            </div>
                        </div>
                    @endif
