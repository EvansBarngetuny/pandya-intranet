{{-- resources/views/livewire/memos/edit-memo.blade.php --}}
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-yellow-500 to-orange-500">
                <h1 class="text-2xl font-bold text-white">Edit Memo</h1>
                <p class="text-yellow-100 text-sm mt-1">Update memo #{{ $memo->memo_number }}</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form wire:submit.prevent="update" class="space-y-6">
                    ...
                    <!-- New Attachments -->
                    <div class="border-t pt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Add New Attachments</h3>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500">
                                        ...
                                        <input type="file" wire:model="new_attachments" multiple class="sr-only">
                                    </label>
